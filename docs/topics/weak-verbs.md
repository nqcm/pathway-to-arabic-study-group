---
title: الأفعال المعتلة — Weak (Irregular) Verbs
tags:
  - arabic-grammar
  - morphology
  - surah-alhujuraat
...
Both naming systems are valid. The فَاء / عَيْن / لَام system refers to the traditional morphological paradigm **فَعَلَ**, where:
- **فَاء الفِعْل** = first radical
- **عَيْن الفِعْل** = second radical
- **لَام الفِعْل** = third radical

!!! tip "Learning Terminology"
...
In theory the muḍāriʿ would be **يَدْعُوُ** but:
1. The wāw (weak letter) becomes unstable with the ḍamma after it
2. The final ḍamma is suppressed → **يَدْعُو**

The final wāw in **يَدْعُو** is the **root letter** — not a pronoun. Therefore, **no alif al-fāriqah** is written.

However, in the plural:
- **يَدْعُونَ** (they call) — the wāw here is **wāw al-jamāʿah** (pronoun) + nūn
- Majzūm: **لَا يَدْعُوا** — nūn dropped; alif al-fāriqah added after the pronoun wāw
...
Many Quranic verbs are weak verbs. The ability to correctly identify:
- which letters are root letters
- which letters are pronouns
- which letters are signs of iʿrāb
