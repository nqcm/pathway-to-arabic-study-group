---
title: Surah An-Noor — Study Session 4
tags:
  - quran
  - arabic-grammar
  - surah-alnoor
...
!!! note "Khalk as Both Process and Product"
...
!!! info "Dābbah: All Creatures Including Humans"
    **دَابَّة** means any creature that moves on earth. In the context of Ayah 45, it includes:
    - Reptiles and crawling animals
    - Two-legged animals (including humans)
    - Four-legged animals
    When humans are mentioned in the same breath as animals, **دَابَّة** covers all of them.
...
!!! important "Faʿʿāl Pattern = Profession or Habit"
    The **فَعَّال** pattern specifically carries the meaning of **occupation or habitual action**. Compare:
    - **طَابِخ** (one who cooks, ism fāʿil) vs. **طَبَّاخ** (professional cook, mubālaghah)
    - **حَالِق** (one who cuts hair) vs. **حَلَّاق** (barber — does it professionally)
    - **سَابِح** (one who is swimming) vs. **سَبَّاح** (professional swimmer / one who swims constantly)
...
The ism fāʿil of **دَبَّ** (doubled root: **د-ب-ب**):
- First the root letters are assimilated: **دَابّ** → with shaddah
- Mubālaghah on **فَعَّال** pattern → **دَبَّاب** (one who crawls constantly/habitually)
- Modern Arabic: **دَبَّابَة** = tank
...
!!! info "Shakūr — A Special Meaning for Allah"
...
!!! note "Why Arbaʿ (Not Arbaʿatun) in Ayah 45"
...
!!! warning "Number Rules Are Complex"
