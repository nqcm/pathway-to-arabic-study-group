---
title: Surah An-Noor — Study Session 11
tags:
  - quran
  - arabic-grammar
  - surah-alnoor
...
1. Root: **ر-أ-ي** → māḍī: **رَأَى**  
2. Muḍāriʿ: originally **يَرْأَى**
3. The **'alif** (weak letter) turns to **'alif** in muḍāriʿ → **يَرَى**  
4. Over centuries of very frequent use, the hamza dropped because **hamza + 'alif** are heavy → the word simplified to **يَرَى**

!!! note "Samāʿī Reduction"
...
!!! important "Mental Rā'ā Takes Two Objects"
...
!!! important "Maṣdar Muʾawwal Blocking Two Positions"
...
**Two types of maṣdar muʾawwal:**
- **أَن + muḍāriʿ manṣūb** → replaces a simple maṣdar (e.g. **أَن تَصُومَ** = fasting)
- **أَنَّ + full sentence** → replaces a more complex nominal/verbal clause
...
!!! important "JMʾS in Manṣūb Ends in Kasra — Not Majrūr"
    **Jamāʿ muʾannath sālim** ends in **ات** with kasra in **both manṣūb and majrūr**. So **صَافَّاتٍ** could be either — context disambiguates:
    - No preposition (ḥarf jarr) before it → not majrūr
    - No muḍāf structure → not muḍāf ilayh
    → Must be **manṣūb** (ḥāl — circumstantial clause: "while they have wings outstretched")
...
!!! important "Third Meaning Is Quranic"
...
!!! tip "The Four Steps to Mastering Balāgha"
    1. **Language acquisition** — get comfortable with Arabic through exposure (children's books, podcasts, simple texts)
    2. **Grammar** — learn the rules so you can analyse sentences
    3. **Read literature** — read poetry and prose extensively to develop a taste for good speech
    4. **Study balāgha rules** — only after the above; rules alone cannot replace exposure
...
!!! tip "Summary of Lessons"
    1. **Rā'ā** (epistemic/mental) takes two mafʿūl bihi; **maṣdar muʾawwal (أَنَّ + sentence)** can replace both at once.
    2. **Qad + muḍāriʿ** has three meanings: possibility, rarity, certainty (last only in Quran).
    3. **Kullun** can take singular or plural agreement depending on whether word or meaning governs.
    4. **Sāra without ilā** = kāna-sister meaning "to become"; **sāra + ilā** = "to return to."
    5. JMʾS endings in kasra can be manṣūb — always check context before assuming majrūr.
