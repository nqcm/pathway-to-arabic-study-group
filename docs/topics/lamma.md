...
!!! example "Surah Al-Hujuraat 49:14"
...
Both لَمَّا and لَوْلَا can have omitted response clauses. See [Jawab al-Shart](jawab-al-shart.md) for the rule that a conditional response can never grammatically precede the conditional clause.
