...
**Summary**: Ism fāʿil and ism mafʿūl of أَبَانَ (Form IV) that look identical on the surface due to the ajwaf root — context determines which meaning is intended.

**Sources**: raw/surah_yusuf_session2.md
...
**Result:** Both look identical — **مُبِين**. Context determines meaning:
- Ism fāʿil: *the one clarifying* (active)
- Ism mafʿūl: *the thing that was clarified* (passive)
